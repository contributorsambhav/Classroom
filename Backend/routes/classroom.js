...
router.put('/add-students/:classroomId', [restrictToLoginUserOnly, restrictToPrincipalOrTeacher], async (req, res) => {
...
router.put('/remove-students/:classroomId', [restrictToLoginUserOnly, restrictToPrincipalOrTeacher], async (req, res) => {
  const { studentIds } = req.body;
