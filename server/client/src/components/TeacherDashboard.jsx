...
const TeacherDashboard = () => {
  ...
  const fetchClassroom = async () => {
    try {
      const res = await axios.get("http://localhost:5000/api/teacher/classroom");
  ...
  const fetchTimetable = async () => {
    try {
      const res = await axios.get("http://localhost:5000/api/teacher/timetable");
  ...
  const handleTimetableSubmit = async (e) => {
    e.preventDefault();
    try {
      const res = await axios.post("http://localhost:5000/api/teacher/timetable", newTimetableEntry);
